...
<h2 style="display: inline">Application for leave</h2>
<hr>
<div class="emp-cell">
    <div class="app-emp">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><select name="leave_type" id="" disabled>
                            <option value="">{{ $item->leave_type }}</option>
                        </select></td>
                    </tr>
                    <tr>
                        <td>Date requested: </td>
                        <td>From <input type="date" name="from" value="{{ $item->date_from }}" disabled> to <input type="date" name="to" value="{{ $item->date_to }}" disabled></td>
                    </tr>
                    <tr>
                        <td>Reason:</td>
