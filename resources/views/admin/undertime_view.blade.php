...
<h2>Application for undertime</h2>
<hr>
<div class="emp-cell">
    <div class="app-emp">
    ...
    <div class="app-form">
        ...
        <form action="/admin/undertime_view" method="POST">
            @csrf
            <table>
                <tbody>
                    ...
                    <tr>
                        <td> </td>
                        <td><input style="font-family: FontAwesome;" type="button" name="under" id="editApp" value="&#xf044; Edit">
