...
@section('main-content')
    <h2>Applications for overtime requests:</h2>
    <table>
        <thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $item->status }}</td>
                <td><a href="/admin/application_overtime/view/{{ $item->emp_id }}/{{ $item->id }}" class="button"><span><i class="far fa-eye"></i></span> View</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
